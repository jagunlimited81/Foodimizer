...
public class DatabaseFiller {
    ...
    public void createTestRecipes() {
        ...
        recipe.setDirections("1. Preheat oven to 325°F (163°C). " +
        ...
        recipe.setDirections("1. In a bowl, mix ground beef, egg, onion, bread crumbs, Worcestershire, garlic, 1/2 teaspoon salt, and 1/4 teaspoon pepper until well blended. " +
        ...
        recipe.setDirections("1.Pound chicken cutlets between plastic wrap to an even 1/2” thickness for even frying." +
                "\n2.Marinate chicken – In a large mixing bowl, combine marinade ingredients, add chicken and stir to coat. " +
                "\n3.Cover and refrigerate 2-4 hours or overnight." +
                "\n4.Dredge Chicken – In a separate shallow bowl, whisk together: flour, baking powder, salt, pepper, paprika, onion powder, and garlic powder. " +
                "\n5.Lift a piece of marinated chicken, letting excess marinade drip off, and dip chicken into the flour mixture, pressing it on with your hands to coat well. " +
        ...
        recipe.setServingSize(1);
        recipe.setDescription("Every time we visit Springfield, Illinois we have to eat one of their famous horseshoes. " +
                "\nThe cheese sauce is a little different depending on where you stop to eat, " +
                "\nseems everyone has their own way of making it.");
        recipe.setDirections("1. Preheat the oven to 400 degrees F (200 degrees C). " +
                "\n2. Spread french fries out on a baking sheet. Bake for 20 minutes in the preheated oven, or until golden brown. " +
                "\n3. Meanwhile, divide the ground beef into four equal parts and form into patties. " +
                "\n4. Fry the patties in a large skillet over medium-high heat until well done, about 4 minutes per side. " +
                "\n5. Melt the butter in a saucepan over medium heat and whisk in the flour. " +
                "\n6. Cook while stirring constantly for 4 minutes to cook out the flavor of raw flour." +
                "\n7. Gradually whisk in the half-and-half so that no lumps form. " +
                "\n8. Bring to a simmer then remove from the heat and add the cheese; stir until melted. Season with salt, pepper, and hot sauce to taste. " +
                "\n9. Place 2 slices of toasted bread onto 2 dinner plates and top each slice with a hamburger patty." +
                "\n10. Top each patty with cooked french fries. Pour the cheese sauce on top of everything and serve immediately. ");
        recipe.setMealType("Lunch and Dinner");
        recipe.setPrepTime(0);
